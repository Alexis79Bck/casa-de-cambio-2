<?php
//dd(public_path('assets/imgs/'), asset('assets/imgs/'));
return [
    ...
    */
    ...
    'auth_logo' => [
        ...
        'img' => [
            'path' => 'assets/imgs/' . env('APP_LOGO'), // antes: 'vendor/adminlte/dist/img/AdminLTELogo.png',
            'alt' => 'Logo',
            'class' => '',
            'width' => 96,
            'height' => 96,
